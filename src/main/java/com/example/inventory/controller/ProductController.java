...
public class ProductController {
    ...
    @GetMapping
    public ResponseEntity<Page<Product>> getProductBySpecification(ProductSpecification specification, @RequestParam(required = false, name = "page", defaultValue = "0") int page, @RequestParam(required = false, name = "size", defaultValue = "2000") int size, @RequestParam(required = false, name = "sort", defaultValue = "") String sort, @RequestParam(required = false, name = "direction", defaultValue = "asc") String direction) {
